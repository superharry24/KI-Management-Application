//Accessed from calendar when hovering. Edits event data, can choose to remove.//Columns for both large and small items. List has edit buttons and includes one make button//Will have a list of all rooms with an edit button next to them, a create room button, and a close button
