...
class NewTaskModal extends React.Component {
    ...
    handleSubmit = async() => {
            const {taskName, category, priority, repeat_interval, interval_amount, description, location} = this.state;
            ...
            {
                const data = {taskName, category, priority, repeat_interval, interval_amount, description, location, image: this.state.image};
                try {
                ...
                <div style={styles.modal}>
                    ...
                    <div style={styles.form}>
                        ...
                        <div style={styles.field}>
                            ...
                            <input type="number" name="interval_amount" placeholder="1" onChange={this.handleChange} style={inputStyle} />
                        </div>)}
                        <div style={styles.field}>
